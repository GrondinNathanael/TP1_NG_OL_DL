...
void when_pm25_equals_11_then_getAQILabelFromPM25_result_bon(void){
    TEST_ASSERT_EQUAL(0, bon.description.compareTo(scale.getAQILabelFromPM25(11).description));
}

void when_pm25_equals_34_then_getAQILabelFromPM25_result_acceptable(void){
    TEST_ASSERT_EQUAL(0, acceptable.description.compareTo(scale.getAQILabelFromPM25(34).description));
}

void when_pm25_equals_54_then_getAQILabelFromPM25_result_mauvaisGroupeSensible(void){
    TEST_ASSERT_EQUAL(0, mauvaisGroupeSensible.description.compareTo(scale.getAQILabelFromPM25(54).description));
}

void when_pm25_equals_149_then_getAQILabelFromPM25_result_mauvaisPourSante(void){
    TEST_ASSERT_EQUAL(0, mauvaisPourSante.description.compareTo(scale.getAQILabelFromPM25(149).description));
}

void when_pm25_equals_249_then_getAQILabelFromPM25_result_tresMauvais(void){
    TEST_ASSERT_EQUAL(0, tresMauvais.description.compareTo(scale.getAQILabelFromPM25(249).description));
}

void when_pm25_equals_250_then_getAQILabelFromPM25_result_Dangereux(void){
    TEST_ASSERT_EQUAL(0, Dangereux.description.compareTo(scale.getAQILabelFromPM25(250).description));
}
